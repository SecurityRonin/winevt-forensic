...
pub fn correlate_sessions(_events: &[EvtxEvent]) -> HashMap<u64, LogonSession> {
    todo!("correlate_sessions not implemented")
}
...
pub fn link_processes_to_sessions(
    _sessions: &mut HashMap<u64, LogonSession>,
    _process_events: &[ProcessEvent],
) {
    todo!("link_processes_to_sessions not implemented")
}

/// Extract all `ProcessEvent`s from `EvtxEvent`s where `event_id == 4688`.
pub fn extract_process_events(_events: &[EvtxEvent]) -> Vec<ProcessEvent> {
    todo!("extract_process_events not implemented")
}
...
pub fn find_lateral_movement(sessions: &[LogonSession]) -> Vec<LateralMovementFinding> {
    let _ = sessions;
    todo!("find_lateral_movement not implemented")
}
...
pub fn find_orphaned_sessions(sessions: &[LogonSession]) -> Vec<&LogonSession> {
    let _ = sessions;
    todo!("find_orphaned_sessions not implemented")
}
